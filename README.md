...
Este proyecto fue desarrollado como parte del curso de Desarrollo Web en el Tecnológico de Monterrey.
...
- Uppsala Conflict Data Program (UCDP) por proporcionar los datos
- OpenStreetMap y Nominatim por el servicio de geocodificación
- Wikipedia por la información de estados
